 ...
 * This implementation assumes that the subdivision is correctly stored inside a DCEL
  and the outer face is numbered -1.
  For each query a pair (1,i) is returned if point is strictly inside face number i.
